...
For future developers, it may be worth to review the [Naming Protocol](https://github.com/RMejiaE/EM-Cmap-Scoring-Tool/blob/main/Phase_1/Naming%20Protocol.md) that was used for this project.
