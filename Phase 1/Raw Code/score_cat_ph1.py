...
def fExt_simpleprintcat(vExtS_rootconcept,vExtL_inputfiles,vExtS_outputfile):
    ...
    for file in vExtL_inputfiles:
        vLocL_inputnames.append(os.path.basename(file))  # extract all the base names of the files.  
