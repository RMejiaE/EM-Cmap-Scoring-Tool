...
import webbrowser
import score_trad_ph1
import score_cat_ph1
...
def fLoc_run():
    ...
    #No output file
        ...
        if (iString_method.get() == '1'): 
            score_trad_ph1.fExt_simpleprinttrad(vExtS_rootconcept,vExtL_inputfiles,vExtS_outputfile)  
            showinfo(title = 'Scoring calculation', message = 'Method: Traditional \n Your results are ready!')

        #Categorical
        else: 
            score_cat_ph1.fExt_simpleprintcat(vExtS_rootconcept,vExtL_inputfiles,vExtS_outputfile)
